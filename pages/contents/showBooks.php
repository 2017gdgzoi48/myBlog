...
<?php
	...
	if(empty($itemInfo)||$itemInfo["type"]!=2)header("location: /../../showMsg.php?msg=此专栏不存在"); 
	$favor=0;
	$like=0;
	$dislike=0;
	if(!empty($userInfo)){
...
<body style="margin: 0px;padding: 0px;background-color: rgba(0, 0, 0, 0.06);">
	...
	<div class="main">
		...
		<div class="rightside">
			...
			<div class="userInfo">
				<span class="author">专栏目录</span>
				<span class="line" style="width: 90%;margin: 10px auto;background-color: #307dc8;"></span>
				<ol class="bookcontent"><?php echo $itemInfo["extraInfo"]; ?></ol> 
			</div>
			<div class="userInfo">
