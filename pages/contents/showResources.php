...
<?php
	...
	if(empty($itemInfo)||$itemInfo["type"]!=3)header("location: /../../showMsg.php?msg=此下载不存在"); 
	$favor=0;
	$like=0;
	$dislike=0;
	if(!empty($userInfo)){
...
<body style="margin: 0px;padding: 0px;background-color: rgba(0, 0, 0, 0.06);">
	...
	<div class="main">
		...
		<div class="rightside">
			...
			<div class="userInfo">
				<span class="author">下载链接</span>
				<span class="line" style="width: 90%;margin: 10px auto;background-color: #307dc8;"></span>
				<a class="tag" href="download.php?id=<?php echo $_GET["id"] ?>" style="text-decoration: none;">点此下载</a>
			</div>
			<div class="userInfo">
